...
function showError(message) {
    ...
    contentEl.innerHTML = `<div style="color: red; padding: 20px; text-align: center;"><h2>${message}</h2></div>`;
    lineNumbersEl.innerHTML = '';
    
    // 移除滚动条
    contentEl.style.overflow = 'hidden';
    lineNumbersEl.style.overflow = 'hidden';
}
...
function fetchFileName() {
    ...
    fetch('/share-view/preview/filename', {
        method: 'POST',
        headers: {
...
function fetchFilePreview(page = 1) {
    ...
    fetch('/share-view/preview/file-preview', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
